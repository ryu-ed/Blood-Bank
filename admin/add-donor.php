			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Añadir donante</h2>
...
<label class="col-sm-2 control-label">Nombre completo<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="fullname" class="form-control" required>
</div>
<label class="col-sm-2 control-label">No. Celular<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Edad<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Genero <span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Tipo de sangre<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="hr-dashed"></div>
<div class="form-group">
<label class="col-sm-2 control-label">Observaciones<span style="color:red">*</span></label>
<div class="col-sm-10">
