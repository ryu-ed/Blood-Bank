			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Administración de paginas </h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Seleccionar Pagina</label>
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***Seleccionar***</option>
              
                  <option value="manage-pages.php?type=aboutus">Acerca</option> 
                  <option value="manage-pages.php?type=donor">Por qué convertirse en donante</option>
                </select>
												</div>
											</div>
