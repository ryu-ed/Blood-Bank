...
<head>
    ...
    <title>Banco de Sangre | Se un Donante</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Se un Donante</h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Inicio</a>
            </li>
            <li class="breadcrumb-item active">Se un Donante</li>
        </ol>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">No. Celular<span style="color:red">*</span></div>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Genero<span style="color:red">*</span></div>
...
<div class="row">
<div class="col-lg-4 mb-4">
<div class="font-italic">Dirección</div>
<div><textarea class="form-control" name="address"></textarea></div>
</div>

<div class="col-lg-8 mb-4">
<div class="font-italic">Mensaje<span style="color:red">*</span></div>
