...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Buscar <small>Donante</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Inicio</a>
            </li>
            <li class="breadcrumb-item active">Buscar Donante</li>
        </ol>
...
<div class="font-italic">Tipo de Sangre<span style="color:red">*</span> </div>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Provincia </div>
...
{ ?>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top img-fluid" src="images/" alt="" ></a>
                    <div class="card-block">
                        <h4 class="card-title"><a href="#"><?php echo htmlentities($result->FullName);?></a></h4>
                        <p class="card-text"><b>No. Celular / Email:</b> <?php echo htmlentities($result->MobileNumber);?> /
...
<p class="card-text"><b> Edad:</b> <?php echo htmlentities($result->Age);?></p>
...
?></p>
     <p class="card-text"><b>Observaciones :</b> <?php echo htmlentities($result->Message);?></p>
